...
urlpatterns=[
    ...
    path("<int:parent_id>/ingredient/image-upload/",  recipe_ingredient_image_upload_view, name='recipe-ingredient-image-upload'),
    path("<int:parent_id>/ingredient/<int:id>/delete/ ", recipe_incredient_delete_view, name='hx-ingredient-delete'),
